...
//        });
//    },
//    createFeature: function (coord, i) {
//        var feature = new ol.Feature({
//            type: 'point',
//            geometry: new ol.geom.Point([coord[i].Lon, coord[i].Lat]).transform('EPSG:4326', 'EPSG:3857')//{ 0:coord[i].Lon, 1: }ol.proj.fromLonLat(coord)
//        });
